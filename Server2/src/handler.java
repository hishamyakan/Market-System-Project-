...
public class handler implements Runnable{
    ...
    private void handleClient(String request)
    {
        ...
        else if(request.contains("Purchase")){
        ...
        //Get Category Report
        //Get Orders Report
        else if (request.contains("Get Category Report"))
        {
            System.out.println("Sending Category Report");
            provider.sendCategoryReport();
        }



        else if (request.contains("Get Orders Report"))
        {
            System.out.println("Sending Orders Report");
            provider.sendOrderReport();
        }

        else if (request.contains("View User History"))
        {
            System.out.println("Sending History");
            provider.sendHistory();
        }
